...
session_start() ;
				...
				$fetchBookingsql = "SELECT * FROM selecteddrive  ";
				...
				$_SESSION['activeuser'] = $rowFetch['snameregistered'] ;
	...
	if ( $hireSqlNum>=0 ) {    
		...
		if ( empty($snameregisteredErr) && empty($selectedDriveWheelErr) && empty($numberOfdaysHiredErr) && empty($paymentModeErr) && empty($mpesaCodeInputErr)   ) {
			...
			if ($hireStmt->execute() === TRUE ) { 
				...
				header('location: fourwheelJeepWranglerregistered.php?hireSubmitTrue') ;
			} else {
				$_SESSION['hireDenied'] ;
				$_SESSION['classTypeError'] ;
				header('location: fourwheelJeepWranglerregistered.php?hireSubmittedFail') ;
			}
		} else {
				$_SESSION['hireDenied'] ;
				$_SESSION['classTypeError'] ;
					    ...
					    <div class="modal-dialog">
					      <div class="modal-content">
					        ...
					        <div class="modal-body">
					        	...
					        	<form class="form" action="fourwheelJeepWranglerregistered.php" method="post">
					        		<!-- <div class="form-group">
					        		...
					        		<div class="form-group" >
					        			...
					        			<select name="selectedDriveWheel" id="selectedDriveWheel" class="form-control form-control-lg"  >
					        				<!-- <option ></option> -->
					        				<option value="JeepWrangler">Jeep Wrangler</option>
					        			</select>
