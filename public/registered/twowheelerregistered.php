...
<div class="container-fluid">
	...
	<div class="col-md-2" id="twowheelnavigation">
		<div class="container-fluid">
			<nav class="">
				<li class="twowheel-item"><a href="twowheelerregistered.php" class="twowheel-link" id="active">Ducatti</a></li>
					...
					<div class="col-md">
						...
						<div class="card-footer">
							...
							<button type="button" class="btn btn-outline-primary">
								<a href="twowheelDucattiregistered.php" class="twowheelermoreinfo">More Info</a>
							</button>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md">
						...
						<div class="card-footer">
							...
							<br/>
							<button type="button" class="btn btn-outline-primary">
								<a href="twowheelDucatti1100registered.php" class="twowheelermoreinfo">More Info</a>
							</button>
						</div>
					</div>
				</div>
