...
<div class="container-fluid">
	...
	<div class="col-md-2" id="twowheelnavigation">
		<div class="container-fluid">
			<nav class="navbar navbar-nav">
				<li class="" id=""><a href="twowheelerregistered.php" class="nav-link text-center text-dark active" id="">Ducatti</a></li>
	...
	<div class="col-md-8">
		<div class="card-deck">
			...
			<div class="card">
				<img src="../../images/twowheeler/ducattiSfV4.jpg" id="twowheelercardimg" class="card-img-top">
				<div class="card-body" style="height: 100%;">
					<p class="text-center">
						<p class="text-center font-weight-bold h3">Ducatti SfV4</p>
						<hr style="width: 50%;" />
						<p>The modern and technological Ducati naked bike has immediately enjoyed great success among motorcyclists all over the world, also confirmed by the positive feedback from the international media.</p>
					</p> <br/>
					<a href="twowheelDucattiregistered.php" class="btn btn-lg text-center btn-outline-primary text-dark font-weight-bold" id="twowheelermoreinfo">More Info</a>
				</div>
			</div>
			...
			<div class="card">
				<img src="../../images/twowheeler/ducatti1100.jpg" id="twowheelercardimg" class="card-img-top">
				<div class="card-body" style="height: 100%;">
					<p class="text-center">
						<p class="text-center font-weight-bold h3">Ducatti 1100</p>
						<hr style="width: 50%;" />
						<p>Ride bigger, ride better. With the Ducati Scrambler 1100, the Land of Joy greets the most demanding and expert motorcyclists, to offer fun, style and freedom in an upgraded and uncompromised fashion.</p>
					</p> <br/>
					<a href="twowheelDucatti1100registered.php" class="btn btn-lg text-center btn-outline-primary text-dark font-weight-bold" id="twowheelermoreinfo">More Info</a>
				</div>
			</div>
