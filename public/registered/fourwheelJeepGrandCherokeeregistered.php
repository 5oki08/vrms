	...
	if ( $hireSqlNum>=0 ) {    
		...
		if ( empty($snameregisteredErr) && empty($selectedDriveWheelErr) && empty($numberOfdaysHiredErr) && empty($paymentModeErr) && empty($mpesaCodeInputErr)   ) {
			...
			if ($hireStmt->execute() === TRUE ) { 
				...
				header('location: fourwheelJeepGrandCherokeeregistered.php?hireSubmitTrue') ;
			} else {
				$_SESSION['hireDenied'] ;
				$_SESSION['classTypeError'] ;
				header('location: fourwheelJeepGrandCherokeeregistered.php?hireSubmittedFail') ;
			}
		} else {
				$_SESSION['hireDenied'] ;
				$_SESSION['classTypeError'] ;
					    ...
					    <div class="modal-dialog">
					      <div class="modal-content">
					        ...
					        <div class="modal-body">
					        	...
					        	<form class="form" action="fourwheelJeepGrandCherokeeregistered.php" method="post">
					        		<!-- <div class="form-group">
