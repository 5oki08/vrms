	...
	if ( $hireSqlNum<=0 ) {
		...
		if ( empty($snameregisteredErr) && empty($selectedDrivetwoWheelErr) && empty($numberOfdaysHiredErr) && empty($paymentModeErr) ) {
			...
			if ($hireStmt->execute() === TRUE ) {
				...
				header('location: fourwheelVantageregistered.php?hireSubmitTrue') ;
			} else {
				$_SESSION['hireDenied'] ;
				$_SESSION['activeuser'] ;
				$_SESSION['classTypeError'] ;
				header('location: fourwheelVantageregistered.php?hireSubmittedFail') ;
			}
		} else {
				$_SESSION['hireDenied'] ;
				$_SESSION['activeuser'] ;
...
function carousel() {
  ...
  setTimeout(carousel, 2000); // Change image every 2 seconds
		...
		<div class="col-md-6">
			...
			<form class="form" method="post" action="fourwheelVantageregistered.php">
				    ...
				    <div class="modal-dialog">
				      <div class="modal-content">
				        ...
				        <div class="modal-body">
				        	...
				        	<form class="form" action="fourwheelVantageregistered.php" method="post">
				        		<div class="form-group">
				        		...
				        		<div class="form-group">
				        			...
				        			<select name="selectedDrivetwoWheel" id="selectedDrivetwoWheel" class="form-control form-control-lg">
				        				<option></option>
				        				<option value="astonMartinVantage">Aston Martin Vantage</option>
				        			</select>
