		...
		<div class="row">
			...
			<div class="col-md-8">
				<nav class="nav nav-expand">
					...
					<li class="nav-item"><a href="aboutregistered.php" class="nav-link" id="active">About Us</a></li>
					<div class="dropdown">
						...
						<div class="dropdown-menu">
							<a href="#" class="dropdown-item">TWO WHEELER VEHICLES</a>
							<a href="#" class="dropdown-item">FOUR WHEELER VEHICLES</a>
						</div>
					</div>	
