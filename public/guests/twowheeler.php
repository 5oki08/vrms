	...
	<div class="col-md-2" id="twowheelnavigation">
		<div class="container-fluid">
			<nav class="navbar navbar-nav">
				<li class="" id=""><a href="twowheeler.php" class="nav-link text-center text-dark active" id="">Ducatti</a></li>
		...
		<div class="card-deck">
			...
			<div class="card">
				...
				<div class="card-body" style="height: 100%;">
					...
					<a href="twowheelDucatti.php" class="btn btn-lg text-center btn-outline-primary text-dark font-weight-bold" id="twowheelermoreinfo">More Info</a>
				</div>
			</div>
			...
			<div class="card">
				...
				<div class="card-body" style="height: 100%;">
					...
					<a href="twowheelDucatti1100.php" class="btn btn-lg text-center btn-outline-primary text-dark font-weight-bold" id="twowheelermoreinfo">More Info</a>
				</div>
			</div>
