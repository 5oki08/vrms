	...
	<div class="col-md-2" id="twowheelnavigation">
		<div class="container-fluid">
			<nav class="navbar navbar-nav">
				...
				<li class="" id=""><a href="twowheelS.php" class="nav-link text-center text-dark active">Suzuki</a></li>
				<li class="" id=""><a href="twowheelYamaha.php" class="nav-link text-center text-dark">Yamaha</a></li>
			</nav>
		</div>
	</div>
		...
		<div class="card-deck">		
			...
			<div class="card">
				...
				<div class="card-body" style="height: 100%;">
					...
					<a href="twowheelsuzukiHayabusa.php" class="btn btn-lg text-center btn-outline-primary text-dark font-weight-bold" id="twowheelermoreinfo">More Info</a>
				</div>
			</div>
			...
			<div class="card">
				...
				<div class="card-body" style="height: 100%;">
					...
					<a href="twowheelSuzukiRM-Z450.php" class="btn btn-lg text-center btn-outline-primary text-dark font-weight-bold" id="twowheelermoreinfo">More Info</a>
				</div>
			</div>
