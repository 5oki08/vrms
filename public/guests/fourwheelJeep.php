	...
	<div class="col-md-2" id="fourwheelnavigation">
		<div class="container-fluid">
			<nav class="navbar navbar-nav">
				...
				<li class="" id=""><a href="fourwheelJeep.php" class="nav-link text-center text-dark active btn btn-lg border border-info" id="fourwheeltitles">Jeep</a></li>
			</nav>
		</div>
	</div>
					  ...
					  <?php switch($id): 
						case 1: ?>
						    <div> 
							    ...
							    <a href="fourwheelJeepWrangler.php" class="btn btn-lg text-center btn-outline-primary text-dark font-weight-bold w-50 mx-auto" style="margin-top:10px;">More Info</a>
							</div> 
						<?php break; ?>
						<?php case 2: ?>
						    <div>
							    <img src="../../images/fourwheeler/<?=$rowFetch['carImage']?>" class="mx-auto" id="fourwheelermoreinfo" class="card-img-top">
							    <a href="fourwheelJeepGrandCherokee.php" class="btn btn-lg text-center btn-outline-primary text-dark font-weight-bold w-50 mx-auto"  style="margin-top:10px;">More Info</a>
						    </div> 
						<?php break; ?>
						<?php endswitch; ?>
				</div> 
